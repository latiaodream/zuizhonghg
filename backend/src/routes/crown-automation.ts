    ...
    try {
	    ...
	    const payload = {
            ...
            awayTeam: body.away_team || body.awayTeam,
	            match_time: body.match_time || body.matchTime,
	            matchTime: body.match_time || body.matchTime,
	            match_status: body.match_status || body.matchStatus,
	            matchStatus: body.match_status || body.matchStatus,
	            current_score: body.current_score || body.currentScore,
	            currentScore: body.current_score || body.currentScore,
	            match_period: body.match_period || body.matchPeriod,
	            matchPeriod: body.match_period || body.matchPeriod,
